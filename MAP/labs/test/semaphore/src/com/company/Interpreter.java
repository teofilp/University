...
//        Print(b)
    ...
    private static ProgramState example10() {
        ...
        var s2 = new DeclarationStatement("cnt", new IntType());
        var s3 = new NewReferenceStatement("v1", new ConstantExpression(new IntValue(1)));
        var s4 = new CreateSemaphoreStatement("cnt", new ReadHeapExpression(new VariableExpression("v1")));

        // first fork

        var s5 = new AcquireStatement("cnt");
        var s6 = new WriteHeapStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(10)), ArithmeticOperator.Multiplication));
        var s7 = new PrintStatement(new ReadHeapExpression(new VariableExpression("v1")));
        var s8 = new ReleaseStatement("cnt");

        var c1 = new CompoundStatement(s7, s8);
        var c2 = new CompoundStatement(s6, c1);
        var c3 = new CompoundStatement(s5, c2);

        var s9 = new RunParallelStatement(c3); // end of first fork

        // second fork
        var s10 = new AcquireStatement("cnt");
        var s11 = new WriteHeapStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(10)), ArithmeticOperator.Multiplication));
        var s12 = new WriteHeapStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(2)), ArithmeticOperator.Multiplication));
        var s13 = new PrintStatement(new ReadHeapExpression(new VariableExpression("v1")));
        var s14 = new ReleaseStatement("cnt");

        var c4 = new CompoundStatement(s13, s14);
        var c5 = new CompoundStatement(s12, c4);
        var c6 = new CompoundStatement(s11, c5);
        var c7 = new CompoundStatement(s10, c6);

        var s15 = new RunParallelStatement(c7); // end of second fork

        var s16 = new AcquireStatement("cnt");
        var s17 = new PrintStatement(new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(1)), ArithmeticOperator.Subtraction));
        var s18 = new ReleaseStatement("cnt");

        var c8 = new CompoundStatement(s17, s18);
        var c9 = new CompoundStatement(s16, c8);
        var c10 = new CompoundStatement(s15, c9);
        var c11 = new CompoundStatement(s9, c10);
