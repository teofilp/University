...
//        Print(b)
    ...
    private static ProgramState example10() {
        var s1 = new DeclarationStatement("a", new IntType());
        var s2 = new DeclarationStatement("b", new IntType());
        var s3 = new DeclarationStatement("c", new IntType());

        var s4 = new AssignmentStatement("a", new ConstantExpression(new IntValue(1)));
        var s5 = new AssignmentStatement("b", new ConstantExpression(new IntValue(2)));
        var s6 = new AssignmentStatement("c", new ConstantExpression(new IntValue(5)));

        var expression = new ArithmeticExpression(new VariableExpression("a"), new ConstantExpression(new IntValue(10)), ArithmeticOperator.Multiplication);
        var cond1Expression = new ArithmeticExpression(new VariableExpression("b"), new VariableExpression("c"), ArithmeticOperator.Multiplication);
        var cond2Expression = new ConstantExpression(new IntValue(10));

        var s7 = new PrintStatement(new VariableExpression("a"));
        var s8 = new PrintStatement(new VariableExpression("b"));
        var c1 = new CompoundStatement(s7, s8); // first print

        var s9 = new PrintStatement(new ConstantExpression(new IntValue(100)));
        var s10 = new PrintStatement(new ConstantExpression(new IntValue(200)));
        var c2 = new CompoundStatement(s9, s10); // second print

        var s11 = new PrintStatement(new ConstantExpression(new IntValue(300))); // third print;

        var switchStatement = new SwitchStatement(expression, cond1Expression, cond2Expression, c1, c2, s11);

        var c3 = new CompoundStatement(switchStatement, s11);
        var c4 = new CompoundStatement(s6, c3);
        var c5 = new CompoundStatement(s5, c4);
        var c6 = new CompoundStatement(s4, c5);
        var c7 = new CompoundStatement(s3, c6);
        var c8 = new CompoundStatement(s2, c7);
        var c9 = new CompoundStatement(s1, c8);
