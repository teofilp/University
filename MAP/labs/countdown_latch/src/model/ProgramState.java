...
public class ProgramState implements Cloneable<ProgramState> {
    ...
    public ProgramState(IStack<Statement> executionStack, IMap<String, Value> symbolTable, IList<Value> output, IMap<String, BufferedReader> fileTable, IHeap heap, Statement program, ILatchTable latchTable) {
    ...
    private ProgramState(IStack<Statement> executionStack, IMap<String, Value> symbolTable, IList<Value> output, IMap<String, BufferedReader> fileTable, ILatchTable latchTable, IHeap heap, int id) {
        this.executionStack = executionStack;
        this.symbolTable = symbolTable;
        this.fileTable = fileTable;
        this.output = output;
    ...
    public String toString() {
        ...
        return new StringBuilder()
                ...
                .append("Latch table").append(separator)
                .append(latchTable).append(separator)
    ...
    public ProgramState clone() {
        return new ProgramState(executionStack.clone(), symbolTable.clone(), output.clone(), fileTable.clone(), latchTable, heap.clone(), id);
    }
