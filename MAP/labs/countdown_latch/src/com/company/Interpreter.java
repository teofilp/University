...
//        Print(b)
    ...
    private static ProgramState example10() {
        ...
        var s8 = new NewLatchStatement("cnt", new ReadHeapExpression(new VariableExpression("v2")));

        var s9 = new WriteHeapStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(10)), ArithmeticOperator.Multiplication));
        var s10 = new PrintStatement(new ReadHeapExpression(new VariableExpression("v1")));
        var s11 = new CountDownLatch("cnt");

        var s12 = new WriteHeapStatement("v2", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v2")), new ConstantExpression(new IntValue(10)), ArithmeticOperator.Multiplication));
        var s13 = new PrintStatement(new ReadHeapExpression(new VariableExpression("v2")));
        var s14 = new CountDownLatch("cnt");

        var s15 = new WriteHeapStatement("v3", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v3")), new ConstantExpression(new IntValue(10)), ArithmeticOperator.Multiplication));
        var s16 = new PrintStatement(new ReadHeapExpression(new VariableExpression("v3")));
        var s17 = new CountDownLatch("cnt");

        var s30 = new AwaitLatchStatement("cnt");
        var s31 = new PrintStatement(new ConstantExpression(new IntValue(100)));
        var s32 = new CountDownLatch("cnt");
        var s33 = new PrintStatement(new ConstantExpression(new IntValue(100)));

        var c100 = new CompoundStatement(s32, s33);
        var c101 = new CompoundStatement(s31, c100);
        var c102 = new CompoundStatement(s30, c101);

        var c1 = new CompoundStatement(s16, s17);
        var c2 = new CompoundStatement(s15, c1);

        var s18 = new RunParallelStatement(c2);

        var c3 = new CompoundStatement(s14, s18);
        var c4 = new CompoundStatement(s13, c3);
        var c5 = new CompoundStatement(s12, c4);

        var s19 = new RunParallelStatement(c5);

        var c6 = new CompoundStatement(s11, s19);
        var c7 = new CompoundStatement(s10, c6);
        var c8 = new CompoundStatement(s9, c7);

        var s20 = new RunParallelStatement(c8);

        var c103 = new CompoundStatement(s20, c102);

        var c9 = new CompoundStatement(s8, c103);
        var c10 = new CompoundStatement(s7, c9);
        var c11 = new CompoundStatement(s6, c10);
        var c12 = new CompoundStatement(s5, c11);
        var c13 = new CompoundStatement(s4, c12);
        var c14 = new CompoundStatement(s3, c13);
        var c15 = new CompoundStatement(s2, c14);
        var c16 = new CompoundStatement(s1, c15);
