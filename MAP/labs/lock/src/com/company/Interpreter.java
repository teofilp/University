...
//        Print(b)
    ...
    private static ProgramState example10() {
        var s1 = new DeclarationStatement("v1", new ReferenceType(new IntType())); // ref int v1
        var s2 = new DeclarationStatement("v2", new ReferenceType(new IntType())); // ref int v2
        var s3 = new DeclarationStatement("x", new IntType()); // int x

        var s4 = new NewReferenceStatement("v1", new ConstantExpression(new IntValue(20))); // new(v1, 20)
        var s5 = new NewReferenceStatement("v2", new ConstantExpression(new IntValue(30))); // new(v2, 30)
        var s6 = new NewLockStatement("x"); // newLock(x)

        var s7 = new LockStatement("x"); // lock(x)
        var s8 = new WriteHeapStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(1)), ArithmeticOperator.Subtraction));
        // wh(v1, rh(v1)-1)
        var s9 = new UnlockStatement("x"); // unlock(x)

        var s10 = new WriteHeapStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(1)), ArithmeticOperator.Addition));
        // wh(v1, rh(v1)+1)

        var c1 = new CompoundStatement(s8, s9);
        var c2 = new CompoundStatement(s7, c1);

        var s11 = new RunParallelStatement(c2); // fork(lock(x), wh(v1, rh(v1)-1), unlock(x))

        var c3 = new CompoundStatement(s10, s9);
        var c4 = new CompoundStatement(s7, c3); // lock(x), wh(v1, rh(v1)+1), unlock(x)

        var c5 = new CompoundStatement(s11, c4);
         ...
         */
        var s12 = new RunParallelStatement(c5); // ***

        var s13 = new WriteHeapStatement("v2", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v2")), new ConstantExpression(new IntValue(1)), ArithmeticOperator.Addition));
        var s14 = new RunParallelStatement(s13);

        var s15 = new WriteHeapStatement("v2", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v2")), new ConstantExpression(new IntValue(1)), ArithmeticOperator.Addition));
        var c6 = new CompoundStatement(s14, s15);
        /*
        fork(
            fork(wh(v2,rh(v2)+1));
         ...
         */
        var s16 = new RunParallelStatement(c6); // ***

        var noOp = new NoOperationStatement();
        var s17 = new PrintStatement(new ReadHeapExpression(new VariableExpression("v1")));
        var s18 = new PrintStatement(new ReadHeapExpression(new VariableExpression("v2")));

        var c7 = new CompoundStatement(s17, s18);
        var c8 = new CompoundStatement(noOp, c7);
        var c9 = new CompoundStatement(noOp, c8);
        var c10 = new CompoundStatement(noOp, c9);
        var c11 = new CompoundStatement(noOp, c10);
        var c12 = new CompoundStatement(noOp, c11);
        var c13 = new CompoundStatement(noOp, c12);
        var c14 = new CompoundStatement(noOp, c13);
        var c15 = new CompoundStatement(noOp, c14);
        var c16 = new CompoundStatement(noOp, c15);

        var c17 = new CompoundStatement(s16, c16);
        var c18 = new CompoundStatement(s12, c17);
        var c19 = new CompoundStatement(s6, c18);
        var c20 = new CompoundStatement(s5, c19);
        var c21 = new CompoundStatement(s4, c20);
        var c22 = new CompoundStatement(s3, c21);
        var c23 = new CompoundStatement(s2, c22);
        var c24 = new CompoundStatement(s1, c23);
